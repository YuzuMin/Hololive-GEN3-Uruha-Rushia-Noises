...
public class MainActivity extends AppCompatActivity implements Count.CountListener{
    ...
    private void playSound(int num){
        ...
        if(switch2){
            ...
            switch (num) {
                case 3:
                    noise = MediaPlayer.create(this, R.raw.rushianoise1);
                    ...
                    break;
                case 4:
                    noise = MediaPlayer.create(this, R.raw.rushianoise2);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 5:
                    noise = MediaPlayer.create(this, R.raw.rushianoise3);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 6:
                    noise = MediaPlayer.create(this, R.raw.rushianoise4);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 7:
                    noise = MediaPlayer.create(this, R.raw.rushianoise5);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 8:
                    noise = MediaPlayer.create(this, R.raw.rushianoise6);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 9:
                    noise = MediaPlayer.create(this, R.raw.rushianoise7);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 10:
                    noise = MediaPlayer.create(this, R.raw.rushianoise8);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 11:
                    noise = MediaPlayer.create(this, R.raw.rushianoise9);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 12:
                    noise = MediaPlayer.create(this, R.raw.rushianoise10);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 13:
                    noise = MediaPlayer.create(this, R.raw.rushianoise11);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 14:
                    noise = MediaPlayer.create(this, R.raw.rushianoise12);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 15:
                    noise = MediaPlayer.create(this, R.raw.rushianoise13);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 16:
                    noise = MediaPlayer.create(this, R.raw.rushianoise14);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 17:
                    noise = MediaPlayer.create(this, R.raw.rushianoise15);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 18:
                    noise = MediaPlayer.create(this, R.raw.rushianoise16);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 19:
                    noise = MediaPlayer.create(this, R.raw.rushianoise17);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 20:
                    noise = MediaPlayer.create(this, R.raw.rushianoise18);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 21:
                    noise = MediaPlayer.create(this, R.raw.rushianoise19);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 22:
                    noise = MediaPlayer.create(this, R.raw.rushianoise20);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 23:
                    noise = MediaPlayer.create(this, R.raw.rushianoise21);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 24:
                    noise = MediaPlayer.create(this, R.raw.rushianoise22);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 25:
                    noise = MediaPlayer.create(this, R.raw.rushianoise23);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 26:
                    noise = MediaPlayer.create(this, R.raw.rushianoise24);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 27:
                    noise = MediaPlayer.create(this, R.raw.rushianoise25);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 28:
                    noise = MediaPlayer.create(this, R.raw.rushianoise26);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 29:
                    noise = MediaPlayer.create(this, R.raw.rushianoise27);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 30:
                    noise = MediaPlayer.create(this, R.raw.rushianoise28);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 31:
                    noise = MediaPlayer.create(this, R.raw.rushianoise29);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 32:
                    noise = MediaPlayer.create(this, R.raw.rushianoise30);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 33:
                    noise = MediaPlayer.create(this, R.raw.rushianoise31);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 34:
                    noise = MediaPlayer.create(this, R.raw.rushianoise32);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 35:
                    noise = MediaPlayer.create(this, R.raw.rushianoise33);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 36:
                    noise = MediaPlayer.create(this, R.raw.rushianoise34);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 37:
                    noise = MediaPlayer.create(this, R.raw.rushianoise35);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 38:
                    noise = MediaPlayer.create(this, R.raw.rushianoise36);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 39:
                    noise = MediaPlayer.create(this, R.raw.rushianoise37);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 40:
                    noise = MediaPlayer.create(this, R.raw.rushianoise38);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 41:
                    noise = MediaPlayer.create(this, R.raw.rushianoise39);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 42:
                    noise = MediaPlayer.create(this, R.raw.rushianoise40);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 43:
                    noise = MediaPlayer.create(this, R.raw.rushianoise41);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 44:
                    noise = MediaPlayer.create(this, R.raw.rushianoise42);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 45:
                    noise = MediaPlayer.create(this, R.raw.rushianoise43);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 46:
                    noise = MediaPlayer.create(this, R.raw.rushianoise44);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 47:
                    noise = MediaPlayer.create(this, R.raw.rushianoise45);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 48:
                    noise = MediaPlayer.create(this, R.raw.rushianoise46);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 49:
                    noise = MediaPlayer.create(this, R.raw.rushianoise47);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 50:
                    noise = MediaPlayer.create(this, R.raw.rushianoise48);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 51:
                    noise = MediaPlayer.create(this, R.raw.rushianoise49);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 52:
                    noise = MediaPlayer.create(this, R.raw.rushianoise50);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 53:
                    noise = MediaPlayer.create(this, R.raw.rushianoise51);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 54:
                    noise = MediaPlayer.create(this, R.raw.rushianoise52);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 55:
                    noise = MediaPlayer.create(this, R.raw.rushianoise53);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 56:
                    noise = MediaPlayer.create(this, R.raw.rushianoise54);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
                    ...
                    break;
                case 57:
                    noise = MediaPlayer.create(this, R.raw.rushianoise55);
                    noise.setOnCompletionListener(listener);
                    noise.start();
                    if (switch1) {
